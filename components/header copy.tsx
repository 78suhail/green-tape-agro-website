  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed inset-0 bg-black/40 z-40 transition-opacity duration-300 ${isMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
          }`}
      />

      {/* ===== MOBILE DRAWER MENU ===== */}
      <div
        className={`fixed top-0 left-0 h-full w-72 bg-green-900 shadow-2xl z-50 transform transition-transform duration-500 ease-in-out ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
        {/* Drawer Header */}
        ...
        <div className="flex flex-col p-6 space-y-5">
          ...
          <a href="tel:+919999999999" onClick={() => setIsMenuOpen(false)}>
